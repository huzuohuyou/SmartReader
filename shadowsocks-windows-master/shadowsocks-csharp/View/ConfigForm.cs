...
namespace Shadowsocks.View
{
    public partial class ConfigForm : Form
    {
        ...
        {
            //加载配置
            //IEntity sse = new ShadowSocksEntity();
            //BimtProxyService bps = new BimtProxyService(ref sse);

            //IPTextBox.Text = ((ShadowSocksEntity)sse).ip;
            //ServerPortTextBox.Text = ((ShadowSocksEntity)sse).port;
            //PasswordTextBox.Text = ((ShadowSocksEntity)sse).password;
            Start();
